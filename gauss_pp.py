...
if __name__ == "__main__":
	# the main holds all parts of 4a, b, c, d
	A = np.array([[13.,17.,1.,5.],[0.,1.,19.,1.],[0.,12.,-1.,0.]], dtype='d')
	B = np.array([[1.,1.,-1.,0.],[0.,12.,-1.,4.],[2.,1.,1.,5.]], dtype='d')
	C = np.array([[5.,1.,-6.,7.],[2.,1.,-1.,8.],[6.,12.,1.,9.]], dtype='d')
	D = np.array([[1.,-1.,1.,5.],[7.,5.,-1.,8.],[2.,1.,1.,7.]], dtype='d')
	print('4a')
	print(A)
	print('Solution, Row Interchanges: ' + str(gaussian_elimination(A)))
	print('')
	print('4b')
	print(B)
	print('Solution, Row Interchanges: ' + str(gaussian_elimination(B)))
	print('')
	print('4c')
	print(C)
	print('Solution, Row Interchanges: ' + str(gaussian_elimination(C)))
	print('')
	print('4d')
	print(D)
	print('Solution, Row Interchanges: ' + str(gaussian_elimination(D)))