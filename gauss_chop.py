...
if __name__ == "__main__":
	...
	A = np.array([[58.9,.03,59.2],[-6.1,5.31,47.]], dtype='d')
	B = np.array([[3.3330,15920.,10.333,7953.],[2.2220,16.710,9.6120,0.965],[-1.5611,5.1792,-1.6855,2.714]], dtype='d')
	print('4a')
	print(A)
	print('Solution: ' + str(gaussian_elimination(A)))
	print('')
	print('4b')
	print(B)
	print('Solution: ' + str(gaussian_elimination(B)))